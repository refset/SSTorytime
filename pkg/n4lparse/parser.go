//**************************************************************
//
// N4LParser and compiler — library extraction of src/N4L/N4L.go.
//
// Parsing state is kept in package-level globals (mirrors the
// upstream command). Callers that share state across files must
// serialize calls.
//
//**************************************************************
